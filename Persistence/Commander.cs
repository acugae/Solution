...
/// </summary>
public class Commander : GCollection<string, string>
{
    private DataManager _oData = null;
    //private cGCollection<string, string> _ocSQL = new cGCollection<string, string>();
    private GCollection<string, GCollection<string, object>> _ocParams = new GCollection<string, GCollection<string, object>>();
    ...
    public Commander(DataManager oDataManager)
    {
        _oData = oDataManager;
    ...
    private GCollection<string, object> GetParams(string sSQL)
    {
        GCollection<string, object> oResult = new GCollection<string, object>();
    ...
    /// </summary>
    public GCollection<string, GCollection<string, object>> Params
    {
    ...
    public DataTable Execute(Connection oConn, string sSQLName)
    {
        if (!ContainsKey(sSQLName))
            throw (new Exception("SQL name not exsist"));
        //
    ...
    /// <returns></returns>
    public DataTable Execute(string sKey, string sSQLName, GCollection<string, string> oParams)
    {
        if (!ContainsKey(sSQLName))
            throw (new Exception("SQL name not exsist"));
        //
    ...
    public DataTable Execute(Connection oConn, string sSQLName, GCollection<string, string> oParams)
    {
        if (!ContainsKey(sSQLName))
            throw (new Exception("SQL name not exsist"));
        //
    ...
    public DataTable Execute(string sKey, string sSQLName, params string[] oParams)
    {
        ...
        //
        string sSQL = (string)this[sSQLName];
        GCollection<string, object> oAPrams = _ocParams[sSQLName];
        //
    ...
    public DataTable Execute(Connection oConn, string sSQLName, params string[] oParams)
    {
        if (!ContainsKey(sSQLName))
            throw (new Exception("SQL name not exsist"));
        //
    ...
    public DataTable Execute(string sKey, string sSQLName, object oObject)
    {
        ...
        string sSQL = (string)this[sSQLName];
        //
        GCollection<string, PropertyInfo> oPropetry = oR.GetProperties(oObject, BindingFlags.Public | BindingFlags.Instance);
    ...
    public DataTable Execute(Connection oConn, string sSQLName, object oObject)
    {
        if (!ContainsKey(sSQLName))
            throw (new Exception("SQL name not exsist"));
        //
