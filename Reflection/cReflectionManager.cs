...
/// </summary>
public class cReflectionManager
{
    /// <summary>
    ...
    public cGCollection<string, PropertyInfo> GetProperties(Object oObject, BindingFlags bindingAttr)
    {
        try
        {
            PropertyInfo[] myProperties = oObject.GetType().GetProperties(bindingAttr);
            cGCollection<string, PropertyInfo> oPs = new cGCollection<string, PropertyInfo>();
    ...
    public cGCollection<string, EventInfo> GetEvents(Object oObject, BindingFlags bindingAttr)
    {
        try
        {
            EventInfo[] myEvents = oObject.GetType().GetEvents(bindingAttr);
            cGCollection<string, EventInfo> oPs = new cGCollection<string, EventInfo>();
    ...
    public void SetControlProperties(object oObject, cGCollection<string, object> PropertyListValue)
    {
    ...
    public cGCollection<string, object> GetPropertiesValue(object oObject)
    {
        PropertyDescriptorCollection properties = TypeDescriptor.GetProperties(oObject);
        cGCollection<string, object> propertyList = new cGCollection<string, object>();
        //
        foreach (PropertyDescriptor myProperty in properties)
        {
            try
