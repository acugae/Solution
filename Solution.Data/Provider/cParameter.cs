...
/// </summary>
public class cParameter : System.Data.IDataParameter
{
    ...
    public cParameter(cConnection oCn)
    {
    ...
    /// </summary>
    /// <param name="oCn"></param>
    public cParameter(cConnection oCn, System.Data.DbType oDbType, System.Data.ParameterDirection oDirection, string sName, object oValue)
    {
        _Parameter = oCn.Provider.CreateDataParameter();
        this.DbType = oDbType;
