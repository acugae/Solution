...
public class cJson
{
    ...
    static public void SerializeToFile(object oObject, string sFileName)
    {
        ...
        cFileManager.SetFile(sFileName, sJSON);
    }

    static public T DeserializeFromFile<T>(string sFileName)
    {
        string sFileString = cFileManager.GetFile(sFileName);
    ...
    static public bool IncludedInto(string sFull, string sPartial)
    {
        ...
        {
            string sValue = cJson.Parse(sFull, oItem.Key);
    ...
    static public string Merge(string sSource, string sDestination, Dictionary<string, cMap> oMap)
    {
        ...
        {
            string sValueSource = cJson.Parse(sSource, item.Key);
            sResult = cJson.Set(sResult, item.Value.sTarget, sValueSource, item.Value.sType);
        }
        return sResult;
    }
