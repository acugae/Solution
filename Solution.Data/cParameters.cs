...
public class cParameters
{
    ...
    public cParameters(cConnection oCn, IDbCommand oCmd)
    {
        this.oCn = oCn;
        _Command = oCmd;
    }
    ...
    /// <param name="oCn"></param>
    /// <param name="oCmd"></param>
    public cParameters(cConnection oCn, cCommand oCmd)
    {
        this.oCn = oCn;
        _Command = oCmd.Command;
    }
    /// <summary>
    /// 
    /// </summary>
    ...
    /// <returns></returns>
    public cParameter Add(string name, System.Data.DbType dbType, int size)
    {
        cParameter oP = new cParameter(oCn);
    ...
    /// <returns></returns>
    public cParameter Add(string name, System.Data.DbType dbType, int size, string sourceColumn)
    {
        cParameter oP = new cParameter(oCn);
        oP.ParameterName = name;
        oP.DbType = dbType;
    ...
    /// <param name="dbType"></param>
    /// <returns></returns>
    public cParameter Add(string name, System.Data.DbType dbType)
    {
        cParameter oP = new cParameter(oCn);
        oP.ParameterName = name;
        oP.DbType = dbType;
    ...
    /// <returns></returns>
    public cParameter Add(string name, object value)
    {
        try
        {
            cParameter oP = new cParameter(oCn);
    ...
    /// <returns></returns>
    public cParameter Add(cParameter oParam)
    {
        try
        {
