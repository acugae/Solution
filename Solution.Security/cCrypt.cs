...
///     </code>
/// </example>
public class cSymmetricCryptAlgorithm
{
    ...
    /// </summary>
    public cSymmetricCryptAlgorithm()
    {
    ...
    public cSymmetricCryptAlgorithm(ServiceProviderEnum serviceProvider)
    {
...
public class cAsymmetricCryptAlgorithm
{
    /// <summary>
    ...
    /// </summary>
    public cAsymmetricCryptAlgorithm()
    {
    ...
    public cAsymmetricCryptAlgorithm(ServiceProviderEnum serviceProvider)
    {
    ...
    /// </summary>
    /// <returns></returns>
    public cCryptKeys CreateKeys()
    {
        cCryptKeys oKeys = new cCryptKeys();
    ...
    public virtual string Encrypt(string cryptoText, cCryptKeys cPublicKey)
    {
    ...
    public virtual string Decrypt(string cryptoText, cCryptKeys cPrivateKey)
    {
    ...
    public virtual byte[] Encrypt(byte[] cryptoBuffer, cCryptKeys cPublicKey)
    {
        AsymmetricAlgorithm oAA = null;
        switch (mAlgorithm)
        {
    ...
    public virtual byte[] Decrypt(byte[] cryptoBuffer, cCryptKeys cPrivateKey)
    {
        AsymmetricAlgorithm oAA = null;
        switch (mAlgorithm)
        {
...
public class cHashAlgorithm
{
    ...
    public cHashAlgorithm(ServiceProviderEnum serviceProvider)
    {
...
public class cCRC16CCITT
{
    ...
    public cCRC16CCITT(InitialCrcValue initialValue)
    {
