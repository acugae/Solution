...
public class cSFTP
{
    ...
    public cSFTP(string sUrl, string sUser, string sPassword, int iPort = 22)
    {
        oFTP = new SftpClient(sUrl, iPort, sUser, sPassword);
    }
    public cSFTP(string sUrl, string sUser, string sPassword, int iPort, string sPathFileKey)
    {
