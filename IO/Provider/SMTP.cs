...
{
    void SetConfig(Dictionary<String, String> parameters, DB _oDB, XML _oXML = null);
    void AddToQueue(DataRow data);
    void Run();
    void Close();
}
public class SMTP : IMailsProvider
{
    string host;
    ...
    public void SetConfig(Dictionary<string, string> parameters, DB _oDB, XML _oXML = null)
    {
        try
        {
