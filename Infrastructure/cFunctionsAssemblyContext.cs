...
public class cFunctionsAssemblyContext : AssemblyLoadContext, IDisposable
{
    private string AssemblyPath { get; set; } = string.Empty;
    Dictionary<string, Assembly> ocAssemblies = [];
    private AssemblyDependencyResolver _resolver;
    readonly cDB DB = null;
    public cFunctionsAssemblyContext(cDB oDB, string sAssemblyPath) : base(name: "FunctionsAssemblyContext", isCollectible: true)
    {
        DB = oDB;
    ...
    public object CallFunction(string sAssemblyName, string sClassName, string sMethodName, FunctionParameters oParameters)
    {
        ...
        ((cModule)oObject).Load(DB, oParameters);
        //
