...
public class XML
{
    ...
    private Collection _oReplaces = null;
    ...
    public void SetReplace(Collection oReplaces)
    {
    ...
    /// <returns></returns>
    private Collection GetAttributeFromParams(string sParams)
    {
        Collection oAttribute = new Collection();
        //
    ...
    /// <returns></returns>
    private bool CompareAttribute(XmlNode oNode, Collection oAttributes)
    {
    ...
    private bool Compare(XmlNode oNode, string sValue)
    {
        ...
        Collection oAttribute = GetAttributeFromParams(sValue);
        //
    ...
    /// <returns></returns>
    private Collection GetAttributes(XmlNode xmlNode)
    {
        Collection oAttributers = new Collection();
        try
        {
            if (xmlNode != null)
            {
    ...
    private void SetAttributes(XmlNode xmlNode, Collection oAttributers)
    {
        try
        {
            if (xmlNode != null)
