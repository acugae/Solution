...
///     "odbdb", "System.Data.Odbc.OdbcFactory"
/// </remarks>
public class cProviders : System.Collections.Specialized.NameObjectCollectionBase
{
    /// <summary>
    ...
    public void Add(cProvider value)
    {
    ...
    {
        cProvider oPM = new cProvider(sKeyProvider, sClassFactoryName, sFilename);
        Add(oPM);
    }
    /// <summary>
    /// 
    /// </summary>
    /// <param name="value"></param>
    public void Set(cProvider value)
    {
    ...
    /// <param name="key"></param>
    /// <returns></returns>
    public cProvider this[string key]
    {
        get { return (cProvider)(base.BaseGet(key)); }
