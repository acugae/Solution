...
public class Trace
{
    ...
    {
        System.Diagnostics.Trace.Listeners.Add(oTL);
    }
    /// <summary>
    ...
    {
        System.Diagnostics.Trace.Listeners.Remove(oTL);
    }
    ...
    public static void WriteLine(bool condition, string sMessage)
    {
        if (bIsSuspend)
            return;
        System.Diagnostics.Trace.WriteLineIf(condition, print(sMessage));
    ...
    public static void WriteLine(string sMessage)
    {
        if (bIsSuspend)
            return;
        System.Diagnostics.Trace.WriteLine(print(sMessage));
        System.Diagnostics.Trace.Flush();
    }
    ...
    public static void WriteLine(string sMessage, string category)
    {
        if (bIsSuspend)
            return;
        System.Diagnostics.Trace.WriteLine(print(sMessage), category);
        System.Diagnostics.Trace.Flush();
    }
    /// <summary>
    ...
    public static void WriteLine(string sMessage, int intLevel)
    {
        ...
        if (intLevel <= iLevel)
        {
            System.Diagnostics.Trace.WriteLine(print(sMessage), intLevel < osLevel.Length ? osLevel[intLevel] : "Unknown");
            System.Diagnostics.Trace.Flush();
        }
    }
    /// <summary>
    ...
    public static void WriteLine(bool condition, string sMessage, int intLevel)
    {
        ...
        if (intLevel <= iLevel)
        {
            System.Diagnostics.Trace.WriteLineIf(condition, print(sMessage), intLevel < osLevel.Length ? osLevel[intLevel] : "Unknown");
            System.Diagnostics.Trace.Flush();
        }
    }
