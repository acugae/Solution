...
public class StringAdvance
{
    ...
    public StringAdvance(string sString)
    {
        _string = sString;
    }
    /// <summary>
    ...
    public DateTime DeserializeDateTime()
    {
        ...
        catch
        {
            try
            {
                if (_string.Length == 8)
                {
                    StringAdvance[] svProva = SubStrings("4&2&2");
    ...
    ///     </code>
    /// </example>
    public StringAdvance[] SubStrings(string sLunghezze)
    {
        try
        {
            string[] svLengh = sLunghezze.Split('&');
            StringAdvance[] svValues = new StringAdvance[svLengh.Length];
            StringAdvance sTemp = _string;
            int lenghtTemp = 0;
            int indexCurr = 0;
            int lenghtCurr = 0;
    ...
    {
        StringAdvance oS = new StringAdvance(_string);
        ...
        for (int i = 0; i < oV.Length; i++)
        {
            ...
            if (oV[i].IndexOf(sBeginTag) < 0)
                continue;
            StringAdvance oS2 = new StringAdvance(oV[i]);
    ...
    private string MargeNumberText(string sNumberValue1, string sNumberValue2)
    {
        ...
        StringAdvance oS1 = sNumberValue1[sNumberValue1.Length - 1].ToString();
        StringAdvance oS2 = sNumberValue2[0].ToString();
    ...
    public static implicit operator StringAdvance(string x)
    {
        StringAdvance s = new StringAdvance(x);
        return s;
    }
    /// <summary>
    ...
    /// <param name="x"></param>
    /// <returns></returns>
    public static implicit operator string(StringAdvance x)
    {
        return x._string;
    }
    //
