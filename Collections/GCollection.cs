...
/// </summary>
/// <see cref="Solution.Collections.Collection"/>
[Serializable]
public class GCollection<K, V> : ISerializable
{
    ...
    //
    private GCollection(SerializationInfo info, StreamingContext context)
    {
    ...
    /// </summary>
    public GCollection(int capacity)
    {
        lock (this)
        {
    ...
    /// </summary>
    public GCollection(GCollection<K, V> oCollection)
    {
        lock (this)
        {
