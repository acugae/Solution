...
public class cDBHttpRoutes
{
    readonly cDB DB;
    public cDBHttpRoutes(cModelConfiguration oConfiguration) => DB = new(oConfiguration);
    public cDBHttpRoutes(cDB oDB) => DB = oDB;
    ...
    public int InsertHttpRoutesHistory(cRoute oRoute, string sBody, HttpRequest oRequest)
    {
